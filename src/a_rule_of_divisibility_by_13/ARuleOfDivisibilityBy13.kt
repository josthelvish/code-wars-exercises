package a_rule_of_divisibility_by_13
 ...
 * shown above, the second right most digit to the second left most digit of the number in the sequence. The cycle goes
 * on and you sum all these products. Repeat this process until the sequence of sums is stationary.
 * ...........................................................................
...
fun thirt(n: Long): Long {
    ...
    while (value > 0) {
        ...
        result += reminder * base.pow(powerOf).toLong().rem(13)
        value /= 10
        powerOf++
    }
    return if (result == n) {
